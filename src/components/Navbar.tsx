...
const Navbar = () => {
    ...
    return (
        ...
        <div className="container flex items-center justify-between">
            <a href="#hero">
                <span className="relative z-10">
                    <span className="text-glow text-foreground">Maryam Roshani</span> Portfolio
                </span>
            </a>
        ...
        <button onClick={() => setIsMenuOpen((prev) => !prev)} className="md:hidden py-2 px-8 text-foreground z-50"
        ...
        : "opacity-0 pointer-events-none"
            ...
            <a 
            href={item.href} 
            key={key}className="text-foreground/80 hover:text-primary transition-colors duration-300"
